...
const Calculator = {
    //thjis displays 0 on the screen
    Display_Value: '0',
...
function Input_Digit(digit) {
    ...
    if ( Wait_Second_Operand === true) {
        ...
        //this overwrties Display_Value if the current value is 0
...
function Handle_Operator(Next_Operator) {
    ...
    //then updates to operator and exits from the function
 ...
 Update_Display();
 //this section moniitors button clicks
